...
class Router(object):
    ...
    def login(self):
        # get salt first
        pw_to_send = hashlib.sha512(bytes(self.password
                                          + self.api['passwordSalt']
        ...
        login_res = self.rsess.post(self.api_base + "/login",
                                    data=strpayload,
    ...
    def system(self):
        ...
        res = self.rsess.get(self.api_base + "/settings/system",
                             headers=Router._HEADERS)
